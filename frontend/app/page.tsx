  ...
  return (
    <>
      ...
      <div className="text-center mb-2">
        Made with ❤️ in <Link className="hyperlink" href="https://en.wikipedia.org/wiki/Brisbane">Brisbane</Link> by <Link className="hyperlink" href="https://johnscolaro.xyz">John</Link>
      </div>
    </>
  );
}
