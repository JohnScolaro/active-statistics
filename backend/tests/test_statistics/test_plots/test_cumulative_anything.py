from backend.statistics.plots import cumulative_anything
...
class TestCumulativeTimeSpent:
    ...
    def test_real_data(self, real_activities) -> None:
        plot_function = cumulative_anything.get_plot_function(
            "moving_time",
            cumulative_anything.conversion_function_for_timedeltas,
            "Hours",
        ...
        plot_function(real_activities)


class TestCumulativeDistance:
    def test_cumulative_distance(self, some_basic_runs_and_rides) -> None:
        plot_function = cumulative_anything.get_plot_function(
            "distance",
...
class TestCumulativeElevation:
    def test_cumulative_elevation(self, some_basic_runs_and_rides) -> None:
        plot_function = cumulative_anything.get_plot_function(
...
class TestCumulativeKudos:
    def test_cumulative_kudos(self, some_basic_runs_and_rides) -> None:
        plot_function = cumulative_anything.get_plot_function(
            "kudos_count",
