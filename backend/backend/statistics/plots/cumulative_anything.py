...
def plot_graph(
    ...
    for activity in activities:
        ...
        year_data[activity_datetime.timetuple().tm_yday - 1] += (
...
def conversion_function_for_timedeltas(attribute_value: dt.timedelta) -> float:
    ...
    hours.
    """
    return attribute_value / 3600


def conversion_function_for_distance_to_km(
    attribute_value: uh._Quantity,
) -> uh._Quantity:
    """
...
def conversion_function_for_distance_to_m(
    attribute_value: uh._Quantity,
) -> uh._Quantity:
    """
    Converts a uh._Quantity representing meters into a float representing
...
if __name__ == "__main__":
    raise NotImplementedError("Local testing not working atm")
